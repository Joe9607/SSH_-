...
border=0>
  ...
  <TR>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr>
     <td width='11%' height="137">预约规则：</td><td colspan="3">只能预约最近一周的门诊号</td>
     ...
     <td width='20%'>剩余预约人数：${yuyue.doctor.renshu-yuyue.shiji }</td>
     <td width='20%'>
     <input type="radio" name="yuyueid" value="${yuyue.id }"  />
      </td>
     </tr>
     </c:forEach>
