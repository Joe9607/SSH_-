	...
	return true;
                      ...
                      <form name="form1" method="post" action="${url }" onsubmit="return checkfrom()">
                        ...
                        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          <tr>
                            <td>用户名：</td>
                            <td><input name='username' type='text' id='usernameid' style="width: 300px;" value="${bean.username }" readonly="readonly" />
                              &nbsp;*</td>
                          </tr>
                          
                          <tr>
                            <td>姓名：</td>
                            <td><input name='xingming' type='text' id='xingmingid' style="width: 300px;" value="${bean.xingming }" readonly="readonly" />
                              &nbsp;*</td>
                          </tr>
                          <tr>
                            <td>性别：</td>
                            <td>
                            <input name='sex' type='text' id='sexid' style="width: 300px;" value="${bean.sex }" readonly="readonly" />
                            </td>
                          </tr>
                          
                          <tr>
                            <td>身份证号码：</td>
                            <td><input name='sfz' type='text' id='sfzid' style="width: 300px;" value="${bean.sfz }" readonly="readonly" />
                            &nbsp;*
                            </td>
                          </tr>
                          <tr>
                            <td>手机号码：</td>
                            <td><input name='dianhua' type='text' id='dianhuaid' style="width: 300px;" value="${bean.dianhua }" />&nbsp;*</td>
                          </tr>
                          <tr>
                            <td>联系地址：</td>
                            <td><input name='address' type='text' id='addressid' style="width: 300px;"  value="${bean.address }" />&nbsp;*</td>
                          </tr>
